            ...
            >
              {EXPLORE_DATA[activeTab].map((item, index) => (
                ...
                >
                  <Link 
                    to={item.link} 
                    className="group block bg-white/70 dark:bg-[#0B1120]/70 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/50 dark:border-white/10 shadow-lg hover:shadow-2xl dark:hover:shadow-[#00A8FF]/10 transition-all duration-500 hover:-translate-y-2 h-full flex flex-col"
                  >
