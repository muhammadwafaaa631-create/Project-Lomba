...
function StatCard({ stat, index }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="group relative flex flex-col items-center text-center p-8 rounded-[2.5rem] bg-white/70 dark:bg-[#0B1120]/70 backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-xl transition-all duration-500"
    >
      {/* Icon Wrapper */}
