export default function CallToAction() {
  return (
    <section className="py-24 px-6 relative overflow-hidden bg-white dark:bg-[#030303] text-center border-t border-slate-100 dark:border-white/5 transition-colors duration-700">
