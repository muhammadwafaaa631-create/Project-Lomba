export const CULTURAL_DATA = [
  // 1. Tradisi & Kearifan Lokal
  {
    id: 1,
    title: "Botram",
    category: "Tradisi & Kearifan Lokal",
    desc: "Budaya Makan Komunal menggunakan alas daun pisang sebagai simbol kebersamaan.",
    image: "/botram.jpg",
    gallery: ["/botram.jpg", "/botram2.jpg"],
    fullDesc: "Botram menekankan pada prinsip kesetaraan. Makan tanpa piring dan sendok di atas hamparan daun pisang menunjukkan bahwa tidak ada perbedaan status sosial saat semua tangan menyentuh nasi yang sama. Di lingkungan urban Bandung, tradisi ini menjadi simbol kerukunan antar tetangga yang tetap terjaga.",
    history: "Berasal dari istilah Sunda kuno yang merujuk pada aktivitas makan bersama secara santai. Diadaptasi dari gaya hidup masyarakat agraris di Jawa Barat sejak abad ke-18, di mana petani menggabungkan lauk pauk mereka di atas daun pisang agar praktis.",
    location: "Taman-taman kota, area pegunungan Lembang, atau halaman rumah."
  },
  {
    id: 2,
    title: "Seren Taun",
    category: "Tradisi & Kearifan Lokal",
    desc: "Upacara Syukur Panen tahunan masyarakat agraris Sunda.",
    image: "/seren taun1.jpg",
    gallery: ["/seren taun1.jpg", "/seren taun2.jpg"],
    fullDesc: "Setelah masuknya Islam, doa-doa dalam ritual ini beradaptasi menjadi doa syukur islami, namun prosesi Ngucluk (memasukkan padi ke lumbung) tetap dipertahankan sebagai inti budaya. Ritual ini merupakan bentuk penghormatan kepada alam yang telah memberikan keberkahan.",
    history: "Nama ini berasal dari Seren (menyerahkan) dan Taun (tahun). Memiliki akar kuat sejak zaman Kerajaan Pajajaran (abad ke-14) sebagai penghormatan kepada Nyi Pohaci Sanghyang Asri (Dewi Padi).",
    location: "Kampung Adat sekitar Bandung atau wilayah Jawa Barat."
  },
  {
    id: 3,
    title: "Munggahan",
  ...
  },
  {
    ...
    title: "Nyaneut",
    category: "Tradisi & Kearifan Lokal",
    desc: "Budaya Minum Teh Tradisional untuk menghangatkan suasana di tengah udara sejuk.",
    image: "/nyaneut1.jpg",
    gallery: ["/nyaneut1.jpg", "/nyaneut2.jpg"],
    fullDesc: "Budaya ini dipopulerkan oleh masyarakat di kaki Gunung Tilu dan Ciwidey yang membutuhkan kehangatan di udara dingin. Nyaneut menjadi sarana komunikasi sosial yang hangat bagi masyarakat pegunungan di sekitar Bandung.",
    history: "Singkatan dari 'Nyaiun haneut' (membuat yang hangat). Berawal saat Bandung menjadi pusat perkebunan teh Belanda di awal abad ke-19, di mana masyarakat lokal mengadaptasi budaya 'Teatime' Eropa menggunakan alat tradisional bambu.",
    location: "Area Bandung Utara atau kafe-kafe bertema tradisional."
  },
  {
    id: 5,
    title: "Nenjrag Bumi",
    category: "Tradisi & Kearifan Lokal",
    desc: "Ritual Izin Tanah & Alam sebagai simbol komunikasi dengan sang pencipta alam.",
    image: "/nenjrag bumi.jpg",
    gallery: ["/nenjrag bumi.jpg", "/nenjrag bumi2.jpg"],
    fullDesc: "Ritual ini mengajarkan manusia untuk selalu meminta izin sebelum mengubah atau menggunakan sumber daya alam. Dipertahankan hingga kini dalam upacara kelahiran bayi atau peletakan batu pertama bangunan sebagai simbol penghormatan manusia terhadap alam semesta.",
    history: "Nama berasal dari Nenjrag (menghentakkan keras) dan Bumi. Berakar dari kepercayaan Sunda kuno yang percaya bahwa tanah memiliki 'penunggu', yang kemudian beradaptasi menjadi filosofi penghormatan terhadap lingkungan.",
    location: "Kampung-kampung adat di pinggiran Bandung."
  },
  {
    id: 6,
    title: "Leuwung Kolot",
    category: "Tradisi & Kearifan Lokal",
    desc: "Sistem Konservasi Hutan Adat yang melarang eksploitasi hutan penyangga.",
    image: "/leung solot1.jpg",
    gallery: ["/leung solot1.jpg", "/leung solot2.jpg"],
    fullDesc: "Sistem zonasi hutan membagi wilayah menjadi: Larangan (tidak boleh dimasuki), Tutupan (hutan lindung), dan Baladaeun (hutan produksi). Memegang teguh filosofi 'Gunung kaian, gawir awian, lebak balongan' sebagai pedoman menjaga ekosistem.",
    history: "Berasal dari Leuwung (hutan) dan Kolot (tua). Merupakan sistem konservasi tradisional masyarakat adat Sunda yang sudah diterapkan jauh sebelum pemerintah kolonial mengenal istilah 'Hutan Lindung'.",
    location: "Wilayah lindung di perbukitan Bandung Barat dan Utara."
  },
